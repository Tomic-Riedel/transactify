...
class TransactionsDatabase with ChangeNotifier{
  ...
  Future _createDB(sql.Database db, int version) async {
    await db.execute(
        'CREATE TABLE IF NOT EXISTS user_transactions (_id INTEGER PRIMARY KEY, title TEXT NOT NULL, amount TEXT NOT NULL, isExpense BOOL NOT NULL, date TEXT NOT NULL)');
  }
